      ...
      switch($typ){
        ...
        case 4: 
          //for($i = 1 ; $i <= 3 ; $i++){
              ...
              IPS_LogMessage('AutoSwitch_Set_JSON', 'Aktion ausgeführt. Ergebnis= '.$result);
           //   if($result==1)
           //       break;
          //}
        break;
        ...
        case 7:
          //for($i = 1 ; $i <= 3 ; $i++){
              ...
              IPS_LogMessage('AutoSwitch_Set_Tasmota', 'Aktion ausgeführt. Ergebnis= '.$result);
          //    if($result==1)
          //        break;
         // }
        break;
        ...
        case 8:
          //for($i = 1 ; $i <= 3 ; $i++){
              ...
              IPS_LogMessage('AutoSwitch_Set_PIGPIO', 'Aktion ausgeführt. Ergebnis= '.$result);
          //    if($result==1)
          //        break;
          //}
        case 9:
        //for($i = 1 ; $i <= 3 ; $i++){
            ...
            IPS_LogMessage('AutoSwitch_Set_MQTT', 'Aktion ausgeführt. Ergebnis= '.$result);
        //    if($result==1)
        //        break;
        //}
        break;
        ...
        //for($i = 1 ; $i <= 3 ; $i++){
            ...
            IPS_LogMessage('AutoSwitch_Set_Zig2MQTT', 'Aktion ausgeführt. Ergebnis= '.$result);
        //    if($result==1)
        //        break;
        //}
        break;
...
//Children durchsuchen
    if(!empty($ID_Children)){
        ...
        IPS_LogMessage("AutoSwitch_FindTargetStatusofDevices","Variable = ".$ZielID);
        return($ZielID);

    }
    
    IPS_LogMessage("AutoSwitch_FindTargetStatusofDevices","Keine ID gefunden!");
    return(0);
}
