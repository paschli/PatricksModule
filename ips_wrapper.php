 ...
 * @version 4.10 (IPSymcon)
 * @date 2017-03-09 (generated)
...
function ARM_SetActive( $InstanceID,$Value ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->ARM_SetActive( $InstanceID,$Value );
	return $result;
}
...
function ARM_SetAlert( $InstanceID,$Status ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->ARM_SetAlert( $InstanceID,$Status );
	return $result;
}
...
* @param Integer $SourceValue
*/

function ARM_TriggerAlert( $InstanceID,$SourceID,$SourceValue ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->ARM_TriggerAlert( $InstanceID,$SourceID,$SourceValue );
	return $result;
}
...
function ARM_UpdateEvents( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->ARM_UpdateEvents( $InstanceID );
	return $result;
}

/**
* AS_GetNextSimulationData
* 
* @returns Array
* @param Integer $InstanceID
*/
...
function AS_GetNextSimulationData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->AS_GetNextSimulationData( $InstanceID );
	return $result;
}
...
function AS_SetSimulation( $InstanceID,$SwitchOn ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->AS_SetSimulation( $InstanceID,$SwitchOn );
	return $result;
}
...
function AS_UpdateData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->AS_UpdateData( $InstanceID );
	return $result;
}
...
function AS_UpdateTargets( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->AS_UpdateTargets( $InstanceID );
	return $result;
}
...
function BA_AddImage( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->BA_AddImage( $InstanceID );
	return $result;
}
...
function BTPC_Scan( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->BTPC_Scan( $InstanceID );
	return $result;
}
...
function BTP_Scan( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->BTP_Scan( $InstanceID );
	return $result;
}
...
function EGZ_ProcessHookData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->EGZ_ProcessHookData( $InstanceID );
	return $result;
}
...
function EZS_Update( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->EZS_Update( $InstanceID );
	return $result;
}
...
function FM_CheckEvent( $InstanceID,$Eventtype ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->FM_CheckEvent( $InstanceID,$Eventtype );
	return $result;
}
...
function FM_SetActive( $InstanceID,$Active ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->FM_SetActive( $InstanceID,$Active );
	return $result;
}
...
function GEO_ProcessHookData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->GEO_ProcessHookData( $InstanceID );
	return $result;
}
...
function IPS_GetInstanceBuffer( $InstanceID,$Name ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_GetInstanceBuffer( $InstanceID,$Name );
	return $result;
}
...
function IPS_RegisterInstanceMessage( $InstanceID,$SenderID,$Message ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_RegisterInstanceMessage( $InstanceID,$SenderID,$Message );
	return $result;
}
...
/**
* IPS_SetForwardDataFilter
* 
* @returns Boolean
* @param Integer $InstanceID
* @param String $RequiredRegexMatch
*/

function IPS_SetForwardDataFilter( $InstanceID,$RequiredRegexMatch ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_SetForwardDataFilter( $InstanceID,$RequiredRegexMatch );
	return $result;
}
...
function IPS_SetInstanceBuffer( $InstanceID,$Name,$Data ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_SetInstanceBuffer( $InstanceID,$Name,$Data );
	return $result;
}
...
function IPS_SetInstanceSummary( $InstanceID,$Summary ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_SetInstanceSummary( $InstanceID,$Summary );
	return $result;
}
...
function IPS_SetReceiveDataFilter( $InstanceID,$RequiredRegexMatch ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_SetReceiveDataFilter( $InstanceID,$RequiredRegexMatch );
	return $result;
}
...
function IPS_UnregisterInstanceMessage( $InstanceID,$SenderID,$Message ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->IPS_UnregisterInstanceMessage( $InstanceID,$SenderID,$Message );
	return $result;
}
...
function LOCA_Register( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->LOCA_Register( $InstanceID );
	return $result;
}

/**
* LOCA_RequestFencelogs
* 
* @returns Array
* @param Integer $InstanceID
*/

function LOCA_RequestFencelogs( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->LOCA_RequestFencelogs( $InstanceID );
	return $result;
}

/**
* LOCA_RequestGeofences
* 
* @returns Array
* @param Integer $InstanceID
*/

function LOCA_RequestGeofences( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->LOCA_RequestGeofences( $InstanceID );
	return $result;
}

/**
* LOCA_RequestUserInformation
* 
* @returns Array
* @param Integer $InstanceID
*/

function LOCA_RequestUserInformation( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->LOCA_RequestUserInformation( $InstanceID );
	return $result;
}
...
function SZS_CallScene( $InstanceID,$SceneNumber ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->SZS_CallScene( $InstanceID,$SceneNumber );
	return $result;
}
...
function SZS_SaveScene( $InstanceID,$SceneNumber ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->SZS_SaveScene( $InstanceID,$SceneNumber );
	return $result;
}
...
function THL_Start( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->THL_Start( $InstanceID );
	return $result;
}
...
function THL_Stop( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->THL_Stop( $InstanceID );
	return $result;
}
...
function UMG_Calculate( $InstanceID,$Value ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->UMG_Calculate( $InstanceID,$Value );
	return $result;
}
...
function UMR_Calculate( $InstanceID,$Value ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->UMR_Calculate( $InstanceID,$Value );
	return $result;
}
...
function UWZ_RequestInfo( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->UWZ_RequestInfo( $InstanceID );
	return $result;
}
...
function WD_CheckTargets( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->WD_CheckTargets( $InstanceID );
	return $result;
}
...
function WD_GetAlertTargets( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->WD_GetAlertTargets( $InstanceID );
	return $result;
}
...
function WD_SetActive( $InstanceID,$SwitchOn ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->WD_SetActive( $InstanceID,$SwitchOn );
	return $result;
}
...
function WGW_UpdateStormWarningData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->WGW_UpdateStormWarningData( $InstanceID );
	return $result;
}
...
function WGW_UpdateWeatherData( $InstanceID ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->WGW_UpdateWeatherData( $InstanceID );
	return $result;
}
...
function ZUL_Update( $InstanceID,$OldValue,$Value ){
	$rpc=$GLOBALS["rpc"];
	$result=$rpc->ZUL_Update( $InstanceID,$OldValue,$Value );
	return $result;
}
